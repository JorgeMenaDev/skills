...
- **Frontmatter**: add `version`, `license`, and a `writes_to: [.seo/]`-style mutation declaration (house precedent: `shiploop`, `work-tracking`). Version metadata also lets exported copies detect staleness (marketingskills pattern: `AGENTS.md:61-68` + `VERSIONS.md`).
