...
If a *fact* can be found by exploring the codebase (or the target repo's docs), look it up rather than asking me. The *decisions*, though, are mine — put each one to me and wait for my answer.
