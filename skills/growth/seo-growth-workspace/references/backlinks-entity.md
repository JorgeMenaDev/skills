...
Use for original-image distribution, reuse discovery, and attribution-reclamation decisions. Substantiation: `references/pages.md`; provider selection: `references/data.md`; disclosure and paid-placement integrity: `references/commercial-integrity.md`; conversion events: `references/conversion.md`.
