...
- Route search/content to `references/content-ops.md`, AI observation to `references/ai-search-visibility.md`, maps/local work to `references/local-seo-gbp.md`, communities to their integrity contract when available, comparisons to `references/pseo-gates.md` plus `references/commercial-integrity.md`, affiliate/referral relationships to their integrity contract when available, and conversion measurement to `references/conversion-cta.md`.
