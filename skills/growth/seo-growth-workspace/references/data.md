...
| What Microsoft AI answers cite | Bing Webmaster Tools, AI Performance: CSV export from the UI, no API | Citations, cited pages and grounding queries (the phrases Copilot searched to find cited pages) for Copilot, Bing AI summaries and some partner surfaces. A sample of citation activity, with no clicks, placement or rank. Public preview since 2026-02-10 | Free |
