...
Use for original-image distribution, reuse discovery, and attribution-reclamation decisions. Backlink lifecycle and verification remain in `references/backlinks-entity.md`; substantiation in `references/page-evidence.md`; provider selection in `references/data-tools.md`; commercial disclosure in `references/commercial-integrity.md`; paid-placement integrity in `references/affiliate-promo-integrity.md`; and conversion events in `references/conversion-cta.md`.
