...
- Arguments are the prompt plus reference images (local paths, or images already in the conversation). There is **no** size, quality, seed or destination argument. Ask for 16:9 in the prompt; output arrived as **1672×941** PNG whatever size was requested.
...
- ~24–27 s per image. Three sequential calls hit no rate limit.
