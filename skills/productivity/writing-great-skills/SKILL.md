...
- [ ] State-dependent behavior uses a bash preamble, not model guessing (PATTERNS.md #1)
- [ ] STOP gates name the failure they prevent (PATTERNS.md #3)
- [ ] Mutating skills declare effects in frontmatter (PATTERNS.md #11)
