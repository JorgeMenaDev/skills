...
const rootDeps = fs.existsSync(pkgPath)
...
function header(relOut) {
  ...
  if (relOut.endsWith(".yml") || relOut.endsWith(".yaml") || relOut.endsWith(".example") || relOut.endsWith(".gitignore") || relOut.endsWith(".sh")) return `# ${line}\n`;
